...
def hook(settings, image_size, crop_size, color, num_class, **kwargs):
    ...
    settings.input_types = [
        ...
        integer_value(num_class)] # labels

    settings.logger.info('Image short side: %s', settings.resize_size)
